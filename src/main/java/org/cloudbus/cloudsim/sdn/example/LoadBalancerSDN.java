...
import org.cloudbus.cloudsim.sdn.nos.NetworkOperatingSystemVmReplicaAware;
...
public class LoadBalancerSDN {
    ...
    public static void main(String[] args) {
        ...
        SimpleExample.VmAllocationPolicyEnum vmAllocPolicy = SimpleExample.VmAllocationPolicyEnum.valueOf(policyName);
        if(args.length > 1)
        ...
        try {
            ...
            SimpleExample.VmAllocationPolicyFactory vmAllocationFac = null;
            NetworkOperatingSystem nos = new NetworkOperatingSystemVmReplicaAware("NOS");
            HostFactory hsFac = new HostFactorySimple();
            LinkSelectionPolicy ls = null;
            switch(vmAllocPolicy) {
                case CombMFF:
                case MFF:
                    vmAllocationFac = new SimpleExample.VmAllocationPolicyFactory() {
...
//				break;
    ...
    protected static SDNDatacenter createSDNDatacenter(String name, String physicalTopology, NetworkOperatingSystem snos, SimpleExample.VmAllocationPolicyFactory vmAllocationFactory) {
